...
$diagnosa_json = json_encode($diagnosa_data);
...
<aside id="sidebar" class="bg-blue-800 text-white w-64 flex-col fixed inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 md:flex z-30">
    ...
    <nav class="flex-1 p-4 space-y-2">
        <a href="dashboard.php" class="sidebar-item active flex items-center p-3 rounded-lg"><i class="fas fa-tachometer-alt w-6 text-center mr-3"></i>Dashboard</a>
        <a href="arsip.php" class="sidebar-item flex items-center p-3 rounded-lg"><i class="fas fa-folder-open w-6 text-center mr-3"></i>Arsip Pasien</a>
        <a href="pencarian.php" class="sidebar-item flex items-center p-3 rounded-lg"><i class="fas fa-search w-6 text-center mr-3"></i>Pencarian Pasien</a>

        <a href="users.php" id="menu-users" class="sidebar-item flex items-center p-3 rounded-lg admin-only"
   style="<?php echo isAdmin() ? '' : 'display: none;'; ?>">
   <i class="fas fa-users-cog w-6 text-center mr-3"></i>Manajemen User
</a>
    ...
    <div class="p-4 border-t border-blue-700">
        ...
        <a href="?logout=true" id="logout-button" class="sidebar-item flex items-center p-3 rounded-lg">
            <i class="fas fa-sign-out-alt w-6 text-center mr-3"></i>Keluar
        </a>
    </div>
</aside>
...
<div class="mb-8">
    <h1 class="text-3xl md:text-4xl font-bold text-gray-900">Selamat Datang, <?php echo $current_user_name; ?>!</h1>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-1 space-y-6">
        ...
        <?php if (isAdmin()): ?>
        <a href="arsip.php" class="block bg-blue-600 text-white p-6 rounded-xl shadow-lg hover:bg-blue-700">
            <h4 class="text-lg font-bold">Manajemen Arsip</h4>
            <p class="mt-1 text-blue-100">Lihat, tambah, atau edit arsip.</p>
        </a>
        <?php else: ?>
        <a href="arsip.php" class="block bg-blue-600 text-white p-6 rounded-xl shadow-lg hover:bg-blue-700">
            <h4 class="text-lg font-bold">Lihat Arsip</h4>
            <p class="mt-1 text-blue-100">Lihat dan cari data arsip pasien.</p>
        </a>
        <?php endif; ?>

        <a href="pencarian.php" class="block bg-gray-800 text-white p-6 rounded-xl shadow-lg hover:bg-gray-900">
            <h4 class="text-lg font-bold">Pencarian Pasien</h4>
            <p class="mt-1 text-gray-300">Temukan data pasien dengan cepat.</p>
        </a>
    </div>
